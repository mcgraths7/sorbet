...
/**
 * `AppShellMain` only makes sense as the scrolling content area of a full
 * shell — shown here inside a real AppShell (header + sidebar + main) with a
 * real page body rather than as an empty pane.
 */
