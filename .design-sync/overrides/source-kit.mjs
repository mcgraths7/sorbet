// forked from design-sync lib/source-kit.mjs — this file statically imports
// './dts.mjs' by relative path, which bypasses package-build.mjs's loadLib()
// override resolution. Forking it here (alongside the dts.mjs fork in this
// same overrides/ dir) makes its `./dts.mjs` import resolve to the fixed
// fork instead of the still-broken bundled original. common.mjs/bundle.mjs
// imports below are repointed back at the bundled lib since they aren't
// forked — no fix needed there.
